...
handlersNumericIcons = Tr.fromList
        ...
        ,("dip_power"                , numericIcon "dip" MsgHasDIP)
        ...
        ,("mil_power"                , numericIcon "mil" MsgHasMIL)
...
handlersForModifiers = Tr.unionL handlersForNonModifiersWithinModifiiers (Tr.fromList
        ...
        ,("cossacks_influence_modifier"           , handleModifier "Orachav influence" (reducedNum plainPcSign))
        ,("cossacks_loyalty_modifier"             , handleModifierWithIcon "Orachav loyalty equilibrium" "cossacks loyalty" (reducedNum (colourPcSign True)))
        ...
        ,("local_amount_of_cawa"                  , handleModifierWithIcon "{{DLC-only|Possible rangers}} per development" "possible cawa (local)" (colourNumSign True))
        ...
        ,("claim_duration"                        , handleModifier "MODIFIER_CLAIM_DURATION" (reducedNum (colourPcSign True)))
        ...
        ,("territories_governing_cost"            , handleModifierWithIcon "MODIFIER_TERRITORY_GOVERNING_COST" "territories governing cost" (reducedNum (colourPcSign False)))
        ...
        ,("transport_power"                       , handleModifierWithIcon "TRANSPORT_POWER" "transport power" (reducedNum (colourPcSign True)))
        ...
        ,("amount_of_banners"                     , handleModifierDlcOnly "Possible shifter regiments" "possible shifter regiments" (reducedNum plainNumSign))
        ,("amount_of_cawa"                        , handleModifierDlcOnly "Possible rangers" "possible cawa" (reducedNum plainNumSign))
        ...
        ,("can_recruit_hussars"                   , rhsAlwaysYes (MsgGenericText "May recruit mythical cavalry"))
        ...
        ,("has_carolean"                          , rhsAlwaysYes (MsgGenericText "Allows ebonsteel infantry"))
        ...
        ,("local_amount_of_carolean"              , handleModifier "Possible ebonsteel infantry from development" (colourNumSign True))
        ...
        ,("allow_janissaries_from_own_faith"      , rhsAlwaysYes (MsgGenericText "Allow ahati in true faith provinces"))
        ...
        ,("allowed_samurai_fraction"              , handleModifier "warrior-monks force limit fraction" (reducedNum (colourPcSign True)))
        ...
        ,("can_recruit_janissaries"               , rhsAlwaysYes (MsgGenericText "Can recruit ahati"))
        ,("can_recruit_rajputs"                   , rhsAlwaysYes (MsgGenericText "Can recruit artificers"))
        ...
        ,("cossacks_privilege_slots"              , handleModifier "Orachav max privileges" (colourNumSign True))
        ...
        ,("has_banners"                           , rhsAlwaysYes (MsgGenericText "Allows shifter units"))
        ...
        ,("has_galleon"                           , rhsAlwaysYes (MsgGenericText "Country can train sea beasts"))
        ,("has_geobukseon"                        , rhsAlwaysYes (MsgGenericText "Country allows degárikes ships"))
        ,("has_man_of_war"                        , rhsAlwaysYes (MsgGenericText "Country allows behemoth ships"))
        ,("has_musketeer"                         , rhsAlwaysYes (MsgGenericText "Country allows musketeer infantry"))
        ,("has_samurai"                           , rhsAlwaysYes (MsgGenericText "Country allows warrior-monk infantry"))
        ,("has_streltsy"                          , rhsAlwaysYes (MsgGenericText "Country allows adeen infantry"))
        ,("has_tercio"                            , rhsAlwaysYes (MsgGenericText "Country allows landslide infantry"))
        ,("has_voc_indiamen"                      , rhsAlwaysYes (MsgGenericText "Country allows sunchaser ships"))
        ...
        ,("local_has_banners"                     , rhsAlwaysYes (MsgGenericText "Allows shifter units"))
        ,("local_has_galleass"                    , rhsAlwaysYes (MsgGenericText "Province allows galleass ships"))
        ,("local_has_geobukseon"                  , rhsAlwaysYes (MsgGenericText "Province allows degárikes ships"))
        ,("local_has_man_of_war"                  , rhsAlwaysYes (MsgGenericText "Province allows behemoth ships"))
        ,("local_has_musketeers"                  , rhsAlwaysYes (MsgGenericText "Province allows musketeer infantry"))
        ,("local_has_streltsy"                    , rhsAlwaysYes (MsgGenericText "Province allows adeen infantry"))
        ,("local_has_voc_indiamen"                , rhsAlwaysYes (MsgGenericText "Province allows sunchaser ships"))
        ...
        ,("has_mamluks"                           , rhsAlwaysYes (MsgGenericText "Country allows shadow warriors"))
        ...
        ,("local_has_mamluks"                     , rhsAlwaysYes (MsgGenericText "Province allows shadow warriors"))
...
-- Anbennar
        ,("artificers_influence_modifier"         , handleModifierWithIcon "Artificers influence"           "artificers influence" (reducedNum plainPcSign))
        ,("artificers_loyalty_modifier"           , handleModifierWithIcon "Artificers loyalty equilibrium" "artificers loyalty" (reducedNum (colourPcSign True)))
        ,("mages_influence_modifier"              , handleModifierWithIcon "Mages influence" "mages influence" (reducedNum plainPcSign))
        ,("mages_loyalty_modifier"                , handleModifierWithIcon "Mages loyalty equilibrium" "mages loyalty" (reducedNum (colourPcSign True)))
        ,("adventurers_influence_modifier"        , handleModifierWithIcon "Adventurers influence" "adventurers influence" (reducedNum plainPcSign))
        ,("adventurers_loyalty_modifier"          , handleModifierWithIcon "Adventurers loyalty equilibrium" "adventurers loyalty" (reducedNum (colourPcSign True)))
        ,("monstrous_tribes_influence_modifier"   , handleModifierWithIcon "Monstrous Tribes influence"           "monstrous tribes influence" (reducedNum plainPcSign))
        ,("monstrous_tribes_loyalty_modifier"     , handleModifierWithIcon "Monstrous Tribes loyalty equilibrium" "monstrous tribes loyalty" (reducedNum (colourPcSign True)))
        ,("khelorvashi_influence_modifier"        , handleModifierWithIcon "Khelorvashi influence"           "khelorvashi influence" (reducedNum plainPcSign))
        ,("khelorvashi_loyalty_modifier"          , handleModifierWithIcon "Khelorvashi loyalty equilibrium" "khelorvashi loyalty" (reducedNum (colourPcSign True)))
        ,("kabiurgako_influence_modifier"         , handleModifierWithIcon "Kabiurgako influence"           "kabiurgako influence" (reducedNum plainPcSign))
        ,("kabiurgako_loyalty_modifier"           , handleModifierWithIcon "Kabiurgako loyalty equilibrium" "kabiurgako loyalty" (reducedNum (colourPcSign True)))
        ,("ajgriijarul_influence_modifier"        , handleModifierWithIcon "Ajgriijarul influence"           "ajgriijarul influence" (reducedNum plainPcSign))
        ,("ajgriijarul_loyalty_modifier"          , handleModifierWithIcon "Ajgriijarul loyalty equilibrium" "ajgriijarul loyalty" (reducedNum (colourPcSign True)))
        ,("chumijemoya_influence_modifier"        , handleModifierWithIcon "Chumijemoya influence"           "chumijemoya influence" (reducedNum plainPcSign))
        ,("chumijemoya_loyalty_modifier"          , handleModifierWithIcon "Chumijemoya loyalty equilibrium" "chumijemoya loyalty" (reducedNum (colourPcSign True)))
        ,("shinukhorchi_influence_modifier"       , handleModifierWithIcon "Shinukhorchi influence"           "shinukhorchi influence" (reducedNum plainPcSign))
        ,("shinukhorchi_loyalty_modifier"         , handleModifierWithIcon "Shinukhorchi loyalty equilibrium" "shinukhorchi loyalty" (reducedNum (colourPcSign True)))
        ,("lowercastes_influence_modifier"        , handleModifierWithIcon "Lower Castes influence" "lower castes influence" (reducedNum plainPcSign))
        ,("lowercastes_loyalty_modifier"          , handleModifierWithIcon "Lower Castes loyalty equilibrium" "lower castes loyalty" (reducedNum (colourPcSign True)))
        ,("middlecastes_influence_modifier"       , handleModifierWithIcon "Middle Castes influence"           "middle castes influence" (reducedNum plainPcSign))
        ,("middlecastes_loyalty_modifier"         , handleModifierWithIcon "Middle Castes loyalty equilibrium" "middle castes loyalty" (reducedNum (colourPcSign True)))
        ,("uppercastes_influence_modifier"        , handleModifierWithIcon "Upper Castes influence"           "upper castes influence" (reducedNum plainPcSign))
        ,("uppercastes_loyalty_modifier"          , handleModifierWithIcon "Upper Castes loyalty equilibrium" "upper castes loyalty" (reducedNum (colourPcSign True)))
        ,("raj_ministries_influence_modifier"     , handleModifierWithIcon "Raj ministries influence"           "raj ministries influence" (reducedNum plainPcSign))
        ,("raj_ministries_loyalty_modifier"       , handleModifierWithIcon "Raj ministries loyalty equilibrium" "raj ministries loyalty" (reducedNum (colourPcSign True)))
        ,("boar_command_influence_modifier"       , handleModifierWithIcon "Boar Command influence"           "boar command influence" (reducedNum plainPcSign))
        ,("boar_command_loyalty_modifier"         , handleModifierWithIcon "Boar Command loyalty equilibrium" "boar command loyalty" (reducedNum (colourPcSign True)))
        ,("elephant_command_influence_modifier"   , handleModifierWithIcon "Elephant Command influence"           "elephant command influence" (reducedNum plainPcSign))
        ,("elephant_command_loyalty_modifier"     , handleModifierWithIcon "Elephant Command loyalty equilibrium" "elephant command loyalty" (reducedNum (colourPcSign True)))
        ,("dragon_command_influence_modifier"     , handleModifierWithIcon "Dragon Command influence" "dragon command influence" (reducedNum plainPcSign))
        ,("dragon_command_loyalty_modifier"       , handleModifierWithIcon "Dragon Command loyalty equilibrium" "dragon command loyalty" (reducedNum (colourPcSign True)))
        ,("lion_command_influence_modifier"       , handleModifierWithIcon "Lion Command influence"           "lion command influence" (reducedNum plainPcSign))
        ,("lion_command_loyalty_modifier"         , handleModifierWithIcon "Lion Command loyalty equilibrium" "lion command loyalty" (reducedNum (colourPcSign True)))
        ,("tiger_command_influence_modifier"      , handleModifierWithIcon "Tiger Command influence"           "tiger command influence" (reducedNum plainPcSign))
        ,("tiger_command_loyalty_modifier"        , handleModifierWithIcon "Tiger Command loyalty equilibrium" "tiger command loyalty" (reducedNum (colourPcSign True)))
        ,("wolf_command_influence_modifier"       , handleModifierWithIcon "Wolf Command influence"           "wolf command influence" (reducedNum plainPcSign))
        ,("wolf_command_loyalty_modifier"         , handleModifierWithIcon "Wolf Command loyalty equilibrium" "wolf command loyalty" (reducedNum (colourPcSign True)))
        ,("gerunanin_loyalty_modifier"            , handleModifierWithIcon "Gerunanin loyalty equilibrium" "gerunanin loyalty" (reducedNum (colourPcSign True)))
        ,("adeen_influence_modifier"              , handleModifierWithIcon "House of the Adeen influence"           "house of the adeen influence" (reducedNum plainPcSign))
        ,("adeen_loyalty_modifier"                , handleModifierWithIcon "House of the Adeen loyalty equilibrium" "house of the adeen loyalty" (reducedNum (colourPcSign True)))
        ,("eunuchs_anb_influence_modifier"        , handleModifierWithIcon "Eunuchs influence"           "eunuchs influence" (reducedNum plainPcSign))
        ,("eunuchs_anb_loyalty_modifier"          , handleModifierWithIcon "Eunuchs loyalty equilibrium" "eunuchs loyalty" (reducedNum (colourPcSign True)))
        ,("ahati_influence_modifier"              , handleModifierWithIcon "Ahati influence"           "ahati influence" (reducedNum plainPcSign))
        ,("ahati_loyalty_modifier"                , handleModifierWithIcon "Ahati loyalty equilibrium" "ahati loyalty" (reducedNum (colourPcSign True)))
        ,("daulophs_influence_modifier"           , handleModifierWithIcon "Daulophs influence"           "daulophs influence" (reducedNum plainPcSign))
        ,("daulophs_loyalty_modifier"             , handleModifierWithIcon "Daulophs loyalty equilibrium" "daulophs loyalty" (reducedNum (colourPcSign True)))
        ,("acolytes_influence_modifier"           , handleModifierWithIcon "Acolytes influence"           "acolytes influence" (reducedNum plainPcSign))
        ,("acolytes_loyalty_modifier"             , handleModifierWithIcon "Acolytes loyalty equilibrium" "acolytes loyalty" (reducedNum (colourPcSign True)))
        ,("vampires_influence_modifier"           , handleModifierWithIcon "Vampires influence"           "vampires influence" (reducedNum plainPcSign))
...
handlersForNonModifiersWithinModifiiers = Tr.fromList
        [("is_imperial_modifier"        , rhsAlwaysYes (MsgGenericText "This modifier only applies to members of the EoA"))
        ,("is_banner_modifier"          , rhsAlwaysYes (MsgGenericText "This modifier only applies to shifter regiments"))
        ,("is_caravel_modifier"         , rhsAlwaysYes (MsgGenericText "This modifier only applies to caravel ships"))
        ,("is_carolean_modifier"        , rhsAlwaysYes (MsgGenericText "This modifier only applies to ebonsteel regiments"))
        ,("is_cawa_modifier"            , rhsAlwaysYes (MsgGenericText "This modifier only applies to ranger regiments"))
        ,("is_cossack_modifier"         , rhsAlwaysYes (MsgGenericText "This modifier only applies to orachav regiments"))
        ,("is_galleass_modifier"        , rhsAlwaysYes (MsgGenericText "This modifier only applies to galleass ships"))
        ,("is_galleon_modifier"         , rhsAlwaysYes (MsgGenericText "This modifier only applies to sea beasts"))
        ,("is_geobukseon_modifier"      , rhsAlwaysYes (MsgGenericText "This modifier only applies to degárikes ships"))
        ,("is_hussars_modifier"         , rhsAlwaysYes (MsgGenericText "This modifier only applies to mythical cavalry regiments"))
        ,("is_janissary_modifier"       , rhsAlwaysYes (MsgGenericText "This modifier only applies to ahati regiments"))
        ,("is_mamluks_modifier"         , rhsAlwaysYes (MsgGenericText "This modifier only applies to shadow warriors regiments"))
        ,("is_man_of_war_modifier"      , rhsAlwaysYes (MsgGenericText "This modifier only applies to behemoth ships"))
        ...
        ,("is_rajput_modifier"          , rhsAlwaysYes (MsgGenericText "This modifier only applies to war artificer regiments"))
        ,("is_revolutionary_guard_modifier", rhsAlwaysYes (MsgGenericText "This modifier only applies to revolutionary guard regiments"))
        ,("is_samurai_modifier"         , rhsAlwaysYes (MsgGenericText "This modifier only applies to warrior-monk regiments"))
        ,("is_streltsy_modifier"        , rhsAlwaysYes (MsgGenericText "This modifier only applies to adeen regiments"))
        ,("is_tercio_modifier"          , rhsAlwaysYes (MsgGenericText "This modifier only applies to landslide infantry regiments"))
        ,("is_voc_indiamen_modifier"    , rhsAlwaysYes (MsgGenericText "This modifier only applies to sunchaser ships"))
...
handlersAtLeast = Tr.fromList
        ...
        -- special units
        ,("num_of_banners"              , handleAtLeastWithIcon "shifter regiments" "banners" plainNum)
        ,("num_of_caravel"              , handleAtLeast "caravel ships" plainNum)
        ,("num_of_carolean"             , handleAtLeast "ebonsteel regiments" plainNum)
        ,("num_of_cawa"                 , handleAtLeast "ranger regiments" plainNum)
        ,("num_of_cossacks"             , handleAtLeast "orachav regiments" plainNum)
        ,("num_of_galleass"             , handleAtLeast "galleass ships" plainNum)
        ,("num_of_galleon"              , handleAtLeast "sea beasts" plainNum)
        ,("num_of_geobukseon"           , handleAtLeast "degárikes ships" plainNum)
        ,("num_of_hussars"              , handleAtLeast "mythical cavalry regiments" plainNum)
        ,("num_of_janissaries"          , handleAtLeast "ahati regiments" plainNum)
        ,("num_of_man_of_war"           , handleAtLeast "behemoth ships" plainNum)
        ,("num_of_marines"              , handleAtLeast "marine regiments" plainNum)
        ,("num_of_musketeers"           , handleAtLeast "musketeer regiments" plainNum)
        ,("num_of_mamluks"              , handleAtLeast "shadow warriors regiments" plainNum)
        ,("num_of_qizilbash"            , handleAtLeast "qizilbash regiments" plainNum)
        ,("num_of_rajput"               , handleAtLeast "war artificer regiments" plainNum)
        ,("num_of_revolutionary_guard"  , handleAtLeast "revolutionary guard regiments" plainNum)
        ,("num_of_samurai"              , handleAtLeast "warrior-monk regiments" plainNum)
        ,("num_of_streltsy"             , handleAtLeast "adeen regiments" plainNum)
        ,("num_of_tercio"               , handleAtLeast "landslide infantry regiments" plainNum)
        ,("num_of_voc_indiamen"         , handleAtLeast "sunchaser ships" plainNum)

        ,("banner_percentage"           , handleAtLeast "of the army as shifter regiments" (reducedNum plainPc))
        ,("caravel_percentage"          , handleAtLeast "of the navy as caravel ships"(reducedNum plainPc))
        ,("carolean_percentage"         , handleAtLeast "of the army as ebonsteel regiments" (reducedNum plainPc))
        ,("cossacks_percentage"         , handleAtLeast "of the army as orachav regiments" (reducedNum plainPc))
        ,("galleass_percentage"         , handleAtLeast "of the navy as galleass ships"  (reducedNum plainPc))
        ,("galleon_percentage"          , handleAtLeast "of the navy as sea beasts" (reducedNum plainPc))
        ,("geobukseon_percentage"       , handleAtLeast "of the navy as degárikes ships" (reducedNum plainPc))
        ,("hussars_percentage"          , handleAtLeast "of the army as mythical cavalry regiments" (reducedNum plainPc))
        ,("janissary_percentage"        , handleAtLeast "of the army as ahati regiments" (reducedNum plainPc))
        ,("mamluks_percentage"          , handleAtLeast "of the army as shadow warriors regiments" (reducedNum plainPc))
        ,("man_of_war_percentage"       , handleAtLeast "of the navy as behemoth ships" (reducedNum plainPc))
        ...
        ,("rajput_percentage"           , handleAtLeast "of the army as war artificer regiments" (reducedNum plainPc))
        ,("samurai_percentage"          , handleAtLeast "of the army as warrior-monk regiments" (reducedNum plainPc))
        ,("streltys_percentage"         , handleAtLeast "of the army as private army regiments" (reducedNum plainPc))
        ,("tercio_percentage"           , handleAtLeast "of the army as landslide infantry regiments" (reducedNum plainPc))
        ,("voc_indiamen_percentage"     , handleAtLeast "of the navy as sunchaser ships" (reducedNum plainPc))
        ]
