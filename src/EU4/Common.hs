...
handlersForNonModifiersWithinModifiiers = Tr.fromList
        ...
        ,("is_streltsy_modifier"        , rhsAlwaysYes (MsgGenericText "This modifier only applies to private army regiments"))
...
handlersAtLeast = Tr.fromList
        ...
        ,("num_of_streltsy"             , handleAtLeast "private army regiments" plainNum)
        ...
        ,("mamluks_percentage"          , handleAtLeast "of the army as ahati regiments" (reducedNum plainPc))
