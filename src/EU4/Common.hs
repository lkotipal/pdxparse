...
handlersForNonModifiersWithinModifiiers = Tr.fromList
        ...
        ,("is_rajput_modifier"          , rhsAlwaysYes (MsgGenericText "This modifier only applies to artificer regiments"))
...
handlersAtLeast = Tr.fromList
        ...
        ,("num_of_rajput"               , handleAtLeast "artificer regiments" plainNum)
        ...
        ,("rajput_percentage"           , handleAtLeast "of the army as artificer regiments" (reducedNum plainPc))
