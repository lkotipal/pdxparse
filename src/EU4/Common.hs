...
handlersForModifiers = Tr.unionL handlersForNonModifiersWithinModifiiers (Tr.fromList
        ...
        ,("allow_client_states"                   , rhsAlwaysYes (MsgGenericText "Can create client states"))
        ...
        ,("monthly_prussian_militarized_society_1", handleModifier "monthly_prussian_militarized_society_1" (colourNumSign True))
        ,("monthly_prussian_militarized_society_2", handleModifier "monthly_prussian_militarized_society_2" (colourNumSign True))
        ,("monthly_prussian_militarized_society_3", handleModifier "monthly_prussian_militarized_society_3" (colourNumSign True))
...
handlersSpecialComplex = Tr.fromList
        ...
        ,("generate_advisor"                , simpleEffectAtom "type" (MsgCreateAdvisor " with skill level scaled to monthly income(if the flag <tt>cheaper_selected_advisor</tt> is set, the advisor is cheaper to hire)"))
